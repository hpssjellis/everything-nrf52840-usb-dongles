...
|:-------------:        | :-------------:| :-------------:    | :-------------:          | :------------:| :-------------:          |
|Arduino IDE            |  ? | [yes](https://www.arduino.cc/en/Guide/NANO33BLE) | [yes](https://learn.adafruit.com/introducing-the-adafruit-nrf52840-feather/arduino-bsp-setup) | [yes, needs j-link](https://medium.com/home-wireless/using-segger-studio-and-nordic-sdk-with-particle-xenon-91e34aeb632a) | [yes, few adjustements](https://learn.sparkfun.com/tutorials/nrf52840-development-with-arduino-and-circuitpython/all)  |
|nrf-connect for desktop|[yes](https://www.novelbits.io/nrf52840-usb-dongle-tutorial-1/) | [yes, best to have a j-link](https://forum.arduino.cc/index.php?topic=649008.msg4392009#msg4392009) | Not sure | Not Sure | Not Sure  |
