        ...
        if ( client.available() )
        {
          ...
          if ( c == '\n' )
          {
            ...
            if ( currentLine.length() == 0 )
            {
              ...
              client.print( "<h2 align=center>Use nrf-connect mobile to switch from Bluetooth to Wifi</h2>" );
              client.print( "<input type=button value='LED ON' onclick=\"{location = '/H'}\">" );
              client.print( "<input type=button value='LED Off' onclick=\"{location = '/L'}\">" );
              client.print( "<input type=button value='disconnect WiFi and start Bluetooth' onclick=\"{location = '/B'}\">" );
